...
import bll.buu.medicinalwatcher.AlarmService;
import bll.buu.medicinalwatcher.Model.AlarmModel;
import bll.buu.medicinalwatcher.R;
import bll.buu.medicinalwatcher.Utils.ActivityManager;
import bll.buu.medicinalwatcher.Utils.DividerItemDecoration;
import bll.buu.medicinalwatcher.Utils.MyTimeSorter;
import bll.buu.medicinalwatcher.data.MyAlarmDataBase;
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.mOverFlowImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cancelAlarm(AlarmActivity.this, id, alarm);

                    Toast.makeText(AlarmActivity.this, "已删除闹钟", Toast.LENGTH_SHORT).show();
...
//            PopupMenu menu = new PopupMenu(AlarmActivity.this, v);
                ...
                mActiveImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (item.mActive.equals("true")) {
                            ...
                            cancelAlarm(AlarmActivity.this, CheckedAlarmID, alarmModel);
                            ...
                            Toast.makeText(AlarmActivity.this, "已开启闹钟", Toast.LENGTH_SHORT).show();
